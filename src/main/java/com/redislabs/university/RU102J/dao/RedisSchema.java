...
public class RedisSchema {
    ...
    static String getRateLimiterKey(String name, long minuteBlock,
                                    long maxHits) {
    ...
    // limiter:[name]:[windowSize]:[maxHits]
    // Redis type: sorted set
    static String getSlidingRateLimiterKey(String name, long windowSize, long maxHits) {
        return KeyHelper.getKey("limiter:" + windowSize + ":" + name + ":" + maxHits);
    }
